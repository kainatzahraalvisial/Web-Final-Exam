...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="AddFeedbackID">
                <Columns>
                    <asp:BoundField DataField="AddFeedbackID" HeaderText="ID" ReadOnly="True" />
            ...
            <br />
            AddFeedback ID: <asp:TextBox ID="txtFeedbackID" runat="server"></asp:TextBox>
            <br />
